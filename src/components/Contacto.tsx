    ...
    <section id="contacto" className="py-32 border-t border-border">
      <div className="container">
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          {/* Left */}
          <div>
            <motion.span {...reveal} className="section-label">// Contacto</motion.span>
            <motion.h2
              {...reveal}
            ...
            >
              Hablemos<span className="text-slash">.</span>
            </motion.h2>
            <motion.p
              {...reveal}
            ...
            >
              Abierto a proyectos freelance de diseño de producto, branding, identidad visual y consultoría creativa. También disponible para colaboraciones con Dynasty Studio.
            </motion.p>
          </div>
          ...
          >
            ...
            <div className="flex items-start p-5 bg-surface border border-border">
              <div>
                <span className="font-mono text-[0.62rem] tracking-widest uppercase text-slash block mb-1">Ubicación</span>
