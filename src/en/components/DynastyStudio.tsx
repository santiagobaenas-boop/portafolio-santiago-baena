        ...
        <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div>
            ...
            >
              ...
              <span className="text-grey">We Create the Future.</span>
            </motion.h2>
            ...
            >
              Dynasty Studio is a 3D animation and VFX studio based in Medellín, Colombia. Co-founded in 2022, we are now a reference in high-quality visual content production for national and international brands.
            </motion.p>
            <motion.p
              {...reveal}
            ...
            >
              As co-director, I lead the commercial, creative, and administrative areas, coordinating 3D animation, rendering, VFX, and stand design projects for consumer, automotive, and health brands.
            </motion.p>
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <div className="space-y-2">
                {['3D Animation', 'VFX & Compositing', 'Modeling & Renders', 'Stands & Experiences'].map(s => (
